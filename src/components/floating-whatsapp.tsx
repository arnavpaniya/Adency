...
export function FloatingWhatsApp() {
  return (
    <div className="fixed bottom-6 right-6 z-[2000] flex flex-col gap-4">
      {/* Instagram Button */}
      <motion.a
        href="https://www.instagram.com/grow_with_adency"
        target="_blank"
        rel="noreferrer"
        initial={{ scale: 0, opacity: 0 }}
        animate={{ scale: 1, opacity: 1 }}
        transition={{ delay: 1, type: "spring", stiffness: 200, damping: 20 }}
        className="bg-white border border-orange-500/10 p-3 rounded-full shadow-[0_20px_50px_rgba(240,112,32,0.25)] hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center group relative"
      ...
      >
        ...
        {/* Tooltip */}
        <div className="absolute right-full mr-4 bg-white text-black text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none w-max border border-orange-500/10">
          Message us
        </div>
      </motion.a>
      ...
      <motion.a
        ...
        className="bg-[#25D366] text-white p-3 rounded-full shadow-[0_20px_50px_rgba(37,211,102,0.25)] hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center group relative"
