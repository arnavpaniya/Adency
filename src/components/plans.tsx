      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <Link 
              href="/plans"
              className="w-full py-4 rounded-xl font-bold text-[#1a1512] border-2 border-[#1a1512] hover:bg-[#1a1512] hover:text-white transition-colors text-center mb-4"
            >
              Select Basic
            </Link>
            <p className="text-[10px] md:text-xs text-[#643f22] font-semibold text-center uppercase tracking-[0.1em] opacity-80 mt-2">
          ...
          >
            ...
            <Link 
              href="/plans"
              className="w-full py-4 rounded-xl font-bold text-white bg-orange-500 hover:bg-orange-400 transition-colors shadow-lg shadow-orange-500/20 text-center mb-4"
            >
              Select Premium
            </Link>
            <p className="text-[10px] md:text-xs text-orange-200/60 font-semibold text-center uppercase tracking-[0.1em] mt-2">
              No Upfront Payment — Pay Only After Delivery
            </p>
          </motion.div>
        </div>
